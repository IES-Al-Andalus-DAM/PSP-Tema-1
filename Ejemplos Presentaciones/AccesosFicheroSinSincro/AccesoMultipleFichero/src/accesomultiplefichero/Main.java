...
public class Main {
    ...
    public static void main(String[] args) {
      ...
      try{
          // javalog.txt se abrirá para añadir al final del fichero cada vez
          // que se escriba en él
          PrintStream ps = new PrintStream(
                             new BufferedOutputStream(new FileOutputStream(
                             new File("javalog.txt"),true)), true);
          // Redireccionar la salida estándar y la salida de error
      ...
      if (osName.toUpperCase().contains("WIN")){ //Windows
        if (args.length > 1)
          ...
          //Hemos recibido la ruta del fichero en la línea de comandos
               ...
               nombreFichero = "/home/ramon/valor.txt";
               //Fichero que se utilizará por defecto
        }
      }
      ...
      if (!archivo.exists()){
        ...
        try {
            archivo.createNewFile(); //Lo creamos nuevo
      ...
      try{
         ...
         // Lectura del fichero que contiene un número entero
         String linea;
         linea = br.readLine();
      ...
      //Incrementamos el valor leido del fichero
      valor ++;
